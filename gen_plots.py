...
file_list = [['DisplacementPositiveClipToFrame.csv',1,''],
             ['DisplacementPositiveClipToSkin.csv',0,''],
             ['DisplacementVeryHighWeldsClipToFrame.csv',1,''],
             ['DisplacementVeryHighWeldsClipToSkin.csv',0,'']]
